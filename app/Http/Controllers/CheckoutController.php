...
use Session;
use Auth;
use Payment\SslcommerzController;
        ...
        if ($request->payment_option != null) {
            ...
            if ($request->session()->get('combined_order_id') != null) {
                ...
                if ($request->payment_option == 'cash_on_delivery') {
                    $decorator = __NAMESPACE__ . '\\Payment\\' . str_replace(' ', '', ucwords(str_replace('_', ' ', 'Sslcommerz'))) . "Controller";
                }else{
                   $decorator = __NAMESPACE__ . '\\Payment\\' . str_replace(' ', '', ucwords(str_replace('_', ' ', $request->payment_option))) . "Controller"; 
                }
                ...
                if (class_exists($decorator)) {
                    ...
                    //return (new SslcommerzController)->pay($request);
